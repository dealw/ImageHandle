...
public class ImageController {
    ...
    public String img2Gray(@ApiParam("图片") MultipartFile file,
                           @ApiParam("R倍数") @RequestParam double grayR,
                           @ApiParam("G倍数") @RequestParam double grayG,
                           @ApiParam("B倍数") @RequestParam double grayB,
    ...
    public String img2Binary(@ApiParam("图片") MultipartFile file,
                             ...
                             @ApiParam("G倍数") @RequestParam double grayG,
                             @ApiParam("B倍数") @RequestParam double grayB,
                             @ApiParam("阈值") @RequestParam int threshold,
